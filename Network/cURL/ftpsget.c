//Original source code found at : https://curl.haxx.se/libcurl/c/ftpsget.html
...
#define LOCAL_FILE      "yourfile.bin"
#define REMOTE_URL      "ftp://user@server/home/user/file.txt"
...
int main(void)
{
	...
	struct FtpFile ftpfile = {
	  LOCAL_FILE, /* name to store the file as if successful */
	  NULL
	};
